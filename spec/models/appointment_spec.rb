...
RSpec.describe Appointment, type: :model do
  ...
  #La parte de arriba también puede ser así:
  # subject {
  #     described_class.new(doctor: Doctor.create(first_name: "Gus", last_name: "Cerati", code: "638383"),
  #                         patient: Patient.create(first_name: "Car", last_name: "Garcia"),
  #                         date: DateTime.now + 1.week)
  #   }
